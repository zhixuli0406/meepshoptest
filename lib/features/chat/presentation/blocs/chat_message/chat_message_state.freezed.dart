...
mixin _$ChatMessageState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MessageEntity> messages) messageSending,
    required TResult Function(
            List<MessageEntity> messages, MessageEntity newMessage)
        messageSent,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MessageEntity> messages)? messageSending,
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl({required final List<MessageEntity> messages})
      : _messages = messages;
...
abstract class Loaded implements ChatMessageState {
  const factory Loaded({required final List<MessageEntity> messages}) =
      _$LoadedImpl;
...
class _$MessageSendingImpl implements MessageSending {
  const _$MessageSendingImpl({required final List<MessageEntity> messages})
      : _messages = messages;
  ...
  @override
  String toString() {
    return 'ChatMessageState.messageSending(messages: $messages)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return messageSending(messages);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return messageSending?.call(messages);
  }
...
abstract class MessageSending implements ChatMessageState {
  const factory MessageSending({required final List<MessageEntity> messages}) =
...
abstract class _$$MessageSentImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<MessageEntity> messages, MessageEntity newMessage});
...
class _$MessageSentImpl implements MessageSent {
  const _$MessageSentImpl(
      {required final List<MessageEntity> messages, required this.newMessage})
      : _messages = messages;
  ...
  @override
  String toString() {
    return 'ChatMessageState.messageSent(messages: $messages, newMessage: $newMessage)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_messages), newMessage);
  ...
  TResult when<TResult extends Object?>({
    ...
    return messageSent(messages, newMessage);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return messageSent?.call(messages, newMessage);
  }
...
abstract class MessageSent implements ChatMessageState {
  const factory MessageSent(
      ...
      required final MessageEntity newMessage}) = _$MessageSentImpl;
